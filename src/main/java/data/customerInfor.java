...
public class customerInfor {
    ...
    String zip_code;
    String phone_number;
    public customerInfor(String lastName, String firstName, String email, String stress_address, String city,String state, String country, String zip_code,String phone_number){
        super();
